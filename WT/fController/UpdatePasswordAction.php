...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (empty($newPassword) || empty($confirmPassword)) {
        header("Location: ../fView/UpdatePassword.php?msg1=" . "New Password and Confirm Password cannot be empty");
        exit;
    } elseif ($newPassword !== $confirmPassword) {
        header("Location: ../fView/UpdatePassword.php?msg1=" . "New Password and Confirm Password must match");
        exit;
    }
