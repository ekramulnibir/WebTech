                ...
                <tr>
                    <td align="center" width="30%">
                        <a href="DoctorProfile.php?id=<?php echo $doctorid; ?>">
                            <img src="../upload/<?php echo $doctorpic; ?>" width='60%' hight='60%'>
                        </a>
                    </td>
                    ...
                    <td align="center">
                        <button>
                            <a href="../nController/DeleteDoctorAction.php?doctorid=<?php echo $doctorid;?>" style="text-decoration:none;">Delete Doctor Profile</a>
                        </button>
                    </td>
                </tr>
                <?php
